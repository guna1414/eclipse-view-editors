...
import com.test.userinterface.UiActivator;


 class SWTImageCanvas extends Canvas {
	 ...
	 */
	public Image loadImage(Image componentImage) {
		/*if (sourceImage != null && !sourceImage.isDisposed()) {
			sourceImage.dispose();
			sourceImage = null;
		}
	...
	private String getFallbackImage() {
		try {
			URL installURL = UiActivator.getDefault().getBundle()
					.getEntry("/");
